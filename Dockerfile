...
# docker build -t collective_blog_ruby .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name collective_blog_ruby collective_blog_ruby
